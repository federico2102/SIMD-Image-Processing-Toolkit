...
.ciclo:
    ...
    ; Division rapida pero inexacta. a >> 2 + a >> 4 + a >> 6 + a >> 8
	movdqu    xmm1, xmm0
	psraw	  xmm1, 2
	movdqu    xmm2, xmm0
	psraw	  xmm2, 4
    ...
    ; Division lenta. Pero exacta
	; punpcklwd xmm0, xmm3			; desenpaqueto de word a double
	; cvtdq2ps  xmm0, xmm0			; convierto los enteros a floats
	; divps     xmm0, [divisor] 	; divido por 3
	; cvttps2dq xmm0, xmm0			; convierto a entero por truncado. xmm0 = t | t | t | t
...
.caso1:
    ...
    ptest   xmm2, xmm2              ; Si la mascara esta en 0, no hay nada que hacer
    jz .caso2
...
.caso2:
    ...
    ptest   xmm3, xmm3              ; Si la mascara esta en 0, no hay nada que hacer
    jz .caso3
